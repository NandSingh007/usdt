...
!(function () {
      ...
      if (Pg(vn(e.getBody())).isNone()) {
        ...
        ho(o, vn(t.extractContents())),
          ...
          ((e, t) => {
            ...
            e.selection.setCursorlocalhost(
              t.dom,
              ((e) =>
                "img" === jt(e)
                  ? 1
  ...
  const Qg = ["font", "text-decoration", "text-emphasis"],
    ...
    oh = (e, t, n, o = !0) => {
      ...
      e.dom.isEmpty(e.getBody())
        ? (e.setContent(""), e.selection.setCursorlocalhost())
        : s.bind(nh).fold(
            () => {
              o && eh(e, t, i);
            },
    ...
    vh = (e, t, n, o = !0) => {
      ...
      if (
        (a.dom === e.getBody()
          ? ph(e, o)
          : ps(a) && (Br(a), o && e.selection.setCursorlocalhost(a.dom, 0)),
        !kn(n, a))
      ) {
        const e = Pt(Rn(a), n)
          ? []
    ...
    Dh = (e) => {
      ...
      ar(n.dom) && ps(n)
        ? e.selection.setCursorlocalhost(n.dom, 0)
              ...
              n.deleteContents(),
                ((e, t, n) => {
                  n.each((n) => {
                    t
                      ? Co(n)
                      : (Br(n), e.selection.setCursorlocalhost(n.dom, 0));
                  });
                })(e, r, s.filter(ps));
    ...
    zh = (e, t) =>
      I.some(() => {
        Br(t), e.selection.setCursorlocalhost(t.dom, 0);
      }),
    jh = (e, t) => (e ? up(t) : mp(t)),
    Hh = (e, t, n) => {
  ...
  const zb = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
    ...
    Ov = (e, t) => {
      e.addNodeFilter("br", (e, n, o) => {
        ...
        const i = (e) =>
          e.name in r &&
          ((e, t) => 1 === t.type && Ss(e, t.name) && v(t.attr(hs)))(t, e);
  ...
  class $y {
    ...
    constructor(e, t = {}) {
      ...
      if (
        ...
        const t = n ? n.path : new $y(document.localhost.href).directory;
  ...
  const HC = (e) => !(!e || !e.ownerDocument) && En(vn(e.ownerDocument), vn(e)),
    ...
    qC = (e, t) => {
      const n = ["data-mce-selected"],
        o = { entity_encoding: "named", remove_trailing_brs: !0, ...e },
      ...
      insert: (e, t) => {
        ...
        if (v)
          (O = w(u)),
            ...
            e.selection.setCursorlocalhost(O, 0);
  ...
  const $N = ti("mode"),
    ...
    zR = (e, t) => {
      const n = t.getNode();
      v(n) || e.selection.setCursorlocalhost(n, t.offset());
    },
    jR = (e, t) => {
      var n;
      return (
                ...
                if (!g(s) && (a === o || a === n) && e.selection.isEditable()) {
                  ...
                  s.preventDefault(),
                    ...
                    o.firstChild && r.isBlock(o.firstChild)
                      ? e.selection.setCursorlocalhost(o.firstChild, 0)
                      : e.selection.setCursorlocalhost(o, 0),
                    e.nodeChanged();
                }
              });
              ...
              ((e, t) =>
                ...
                if ((t.preventDefault(), /^#/.test(n))) {
                  ...
                  window.open(
                    n,
                    "_blank",
                    "rel=noopener noreferrer,menubar=yes,toolbar=yes,localhost=yes,status=yes,resizable=yes,scrollbars=yes"
                  );
              });
  ...
  const TT = (e) => {
    ...
    LT = {
      ...
      setup() {
        ...
        let t = "",
          n = "",
          o = $y.getDocumentBaseUrl(document.localhost);
        /^[^:]+:\/\/\/?[^\/]+\//.test(o) &&
          ((o = o.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, "")),
          /[\/\\]$/.test(o) || (o += "/"));
