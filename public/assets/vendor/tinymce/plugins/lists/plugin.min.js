...
!(function () {
  ...
  const ue = (e) => (t) => l(t) && t.nodeName.toLowerCase() === e,
    ...
    ke = (e, t, n) => {
      const r = e.isEmpty(t);
      return (
        !(n && e.select("span[data-mce-type=bookmark]", t).length > 0) && r
      );
    },
    Te = (e, t) => e.isChildOf(t, e.getRoot()),
    Ae = (e) => (t) => t.options.get(e),
    xe = Ae("lists_indent_on_tab"),
    Ee = Ae("forced_root_block"),
    we = Ae("forced_root_block_attrs"),
    De = (e, t) => {
      const n = e.dom,
      ...
      return (
        !d && a && a.appendChild(n.create("br", { "data-mce-bogus": "1" })), o
      );
    },
    Be = de.DOM,
    Ie = F("dd"),
      ...
      const n = e.dom.getParents(t, e.dom.isBlock),
        r = k(n, (t) => {
          return (
            ...
            !he((r = t)) &&
              !ve(r) &&
              b(_e, (e) => n.isValidChild(r.nodeName, e))
          );
          var n, r;
        });
    ...
    Qe = (e, t) => {
      const n = C(t, (t) => ze(e, t).getOr(t));
      return D(n);
    },
    qe = (e) => /\btox\-/.test(e.className),
    We = (e, t) => O(e, he, Ce).exists((e) => e.nodeName === t && !qe(e)),
  ...
  const tt = (e, t, n) => {
    ...
    pt = (e, t, n) => {
      const r = ((e, t) => {
        ...
        return C(e, (e) => ({ sourceList: e, entries: ut(0, t, n, e) }));
      })(
        t,
        ((e) => {
          const t = C(Ve(e), R);
    ...
    vt = (e) => ht(e, "Flatten"),
    bt = (e) => "\ufeff" === e;
  var Ct = tinymce.util.Tools.resolve("tinymce.dom.BookmarkManager");
  const St = de.DOM,
    Nt = (e) => {
      const t = {},
        n = (n) => {
    ...
    xt = (e, t, n, r) => {
      ...
      if (n && pe(o))
        if (bt(o.textContent)) o = i(o, !1).getOr(o);
        else
          for (
            ...
            o = o.previousSibling;
      if (!n && pe(o))
        if (bt(o.textContent)) o = i(o, !0).getOr(o);
        else
          for (
            null !== o.parentNode && At(e, o.parentNode) && (o = o.parentNode);
            null !== o.nextSibling &&
    ...
    Dt = (e, t) => {
      ...
      if (((r = t.previousSibling), wt(e, t, r))) {
        const o = r;
    ...
    It = (e, t, n) => {
      const r = He(e);
      if (Ge(e, r) || !e.hasEditableRoot()) return;
      const s = ((e) => {
          const t = He(e),
                ...
                ? ((e, t, n, r) => {
                    ...
                    if (o.isEmpty(r))
                      ((e, t, n) => {
                        J(R(n)),
                          $t(e.dom, t, n),
                          e.selection.setCursorlocalhost(n, 0);
                      })(e, n, r);
                    else {
                      const s = Nt(t);
